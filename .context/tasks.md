...
- id: 01K4HEGQ000000000000000002 — title: Implement the first connectivity experiment — owner: Codex — status: planned — last update: 2026-09-07
  ...
  - Next: Implement the small offline-tested infrastructure package. Resolve launch identifiers when needed.
  - Scope: `docs/development.md` and `docs/product.md`; no custom runtime, hardening program, runbook framework, or HA prerequisite.

## Paused / Blocked

- None. Optional launch-input question is pending; documentation is complete.
