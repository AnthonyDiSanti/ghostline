...
Stockholm cutover completed on 2026-09-12 after owner acceptance of both ECS protocols/IP masquerading and unattended stop/start/park/rebuild validation. The old Ubuntu Stockholm host, disk, networking and both EIPs are removed. Native Mac REALITY now passes through OneXraySE for both regions after recurring Amnezia crashes; AWG remains in Amnezia. Stockholm is selected and the VPN was left disconnected; repeated sleep/wake validation remains open. See [Mac client evidence](docs/mac-client-stability.md), [current Stockholm evidence](docs/launch-stockholm-ecs.md) and [Cape Town evidence](docs/launch-cape-town.md). Frankfurt is also retired.
