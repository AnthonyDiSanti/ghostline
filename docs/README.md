...
| Migrate credentials or install owned containers | [Runtime](runtime.md) | Local bundles, pinned builds, explicit migration stages, protocol installation and verification |
