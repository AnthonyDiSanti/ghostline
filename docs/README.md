...
| Inspect deployed resources, launch actions and device evidence | [Frankfurt launch](launch.md), [Cape Town launch](launch-cape-town.md) | Per-target nonsecret observations and remaining trial work |
