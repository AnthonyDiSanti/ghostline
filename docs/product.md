...
- Add a saved second endpoint or another protocol in response to observed need. Separate containers and public identities remain the direction when multiple endpoints exist.
